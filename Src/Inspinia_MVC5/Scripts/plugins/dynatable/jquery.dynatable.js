...
(function($) {
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " a " + bounds[1] + "</span> en ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " en ";
      }
  ...
  function InputsSearch(obj, settings) {
    ...
    this.init = function() {
      ...
      this.create = function () {       
          var $search = $('<input class="form-control" placeholder="Buscar" />', {
            type: 'search',
            id: 'dynatable-query-search-' + obj.element.id,
            'data-dynatable-query': 'Buscar',
            value: settings.dataset.queries.search
        }),       
          $searchSpan = $('<div></div>', {
            id: 'dynatable-search-' + obj.element.id,
              'class': 'dynatable-search input-group',           
            }).append($search);                    
      $search
